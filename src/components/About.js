      ...
      <section id="about">
        <div className="container mx-auto flex px-10 py-20 md:flex-row flex-col items-center">
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center text-white">
            ...
            On weekdays, I make peoples lives easier though cheap and reliable energy, by imbuing intelligence in renewable systems, both municipal and mobile. I'm an embedded firmware engineer, and embedded C, Python and Rust are my trusty tools. 
